import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as t,e as i}from"./app-0ab03366.js";const n="/assets/note-images/mysql/mysql-logo.png",a={},s=i('<h1 id="mysql-基础笔记" tabindex="-1"><a class="header-anchor" href="#mysql-基础笔记" aria-hidden="true">#</a> MySQL 基础笔记</h1><figure><img src="'+n+`" alt="MySQL-logo" tabindex="0" loading="lazy"><figcaption>MySQL-logo</figcaption></figure><h3 id="_1-简介" tabindex="-1"><a class="header-anchor" href="#_1-简介" aria-hidden="true">#</a> 1. 简介</h3><p>MySQL是一种关系型数据库管理系统，由瑞典MySQL AB公司开发，属于Oracle旗下产品。MySQL将数据保存在不同的表中，而不是将所有数据放在一个大仓库内，这样就增加了速度并提高了灵活性。</p><p>MySQL所使用的 SQL 语言是用于访问数据库的最常用标准化语言。MySQL 软件采用了双授权政策，分为社区版和商业版，由于其体积小、速度快、总体拥有成本低，尤其是开放源码这一特点，一般中小型和大型网站的开发都选择 MySQL 作为网站数据库。</p><h3 id="_2-常见命令" tabindex="-1"><a class="header-anchor" href="#_2-常见命令" aria-hidden="true">#</a> 2. 常见命令</h3><p><strong>Windows版本</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看版本</span>
...
#5. 查询当前数据库
SELECT DATABASE();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>方括号[]里的内容可根据情况选填</p><p>字符集通常使用UTF8mb4</p></blockquote><h4 id="_2-ddl表操作" tabindex="-1"><a class="header-anchor" href="#_2-ddl表操作" aria-hidden="true">#</a> 2. DDL表操作</h4><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>#1. 查询当前数据库所有表
SHOW TABLES;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-dml数据操作语言" tabindex="-1"><a class="header-anchor" href="#_6-dml数据操作语言" aria-hidden="true">#</a> 6. DML数据操作语言</h3><h4 id="_1-dml数据操作" tabindex="-1"><a class="header-anchor" href="#_1-dml数据操作" aria-hidden="true">#</a> 1. DML数据操作</h4><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>#1. 给指定字段添加数据
...
-- 删除所有
DELETE FORM user;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>添加数据时需要一一对应</p><p>修改语句的条件如果没有则会修改整张表的所有数据</p><p>删除语句不能删除某一个字段的值，要删除某字段的值用UPDATE 置为null</p><p>删除语句的条件如果没有则会删除整张表的所有数据</p></blockquote><h3 id="_7-dql数据查询语言" tabindex="-1"><a class="header-anchor" href="#_7-dql数据查询语言" aria-hidden="true">#</a> 7. DQL数据查询语言</h3><h4 id="_1-基本查询" tabindex="-1"><a class="header-anchor" href="#_1-基本查询" aria-hidden="true">#</a> 1. 基本查询</h4><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>#1. 查询多个字段
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>null值不参加所有聚合函数运算</p></blockquote><h4 id="_4-分组查询" tabindex="-1"><a class="header-anchor" href="#_4-分组查询" aria-hidden="true">#</a> 4. 分组查询</h4><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code># 分组查询
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>where是分组之前过滤，不满足where条件的不参与分组 having是对分组之后的结果进行过滤</p><p>where不能对聚合函数进行判断，having可以</p><p>执行顺序 where&gt;聚合函数&gt;having</p></blockquote><h4 id="_5-排序查询" tabindex="-1"><a class="header-anchor" href="#_5-排序查询" aria-hidden="true">#</a> 5. 排序查询</h4><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>#升序 asc (可省略)  降序 desc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>如果给表起了别名就不能通过表名.字段来限定</p></blockquote><h4 id="_2-外连接" tabindex="-1"><a class="header-anchor" href="#_2-外连接" aria-hidden="true">#</a> 2. 外连接</h4><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>#左外连接(左表+交集)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>自连接查询可以是内连接查询也可以是外连接查询</p><p>自连接必须起别名</p></blockquote><h4 id="_4-联合查询" tabindex="-1"><a class="header-anchor" href="#_4-联合查询" aria-hidden="true">#</a> 4. 联合查询</h4><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>#联合查询
SELECT 字段列表 FROM 表A ...
UNION[ALL]
SELECT 字段列表 FROM 表B ...;
...
UNION
SELECT *FROM emp WHERE age &gt; 50;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>联合查询到多张表的列数必须保持一致,字段类型也需要保持一致</p></blockquote><h4 id="_5-子查询" tabindex="-1"><a class="header-anchor" href="#_5-子查询" aria-hidden="true">#</a> 5. 子查询</h4><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>#子查询(嵌套查询)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>子查询外部也可以是 INSERT / UPDATE / DELETE / SELECT 任意一个</p><p>子查询位置 WHERE之后 / FROM之后 / SELECT之后</p></blockquote><h3 id="_12-事务" tabindex="-1"><a class="header-anchor" href="#_12-事务" aria-hidden="true">#</a> 12. 事务</h3><h4 id="_1-事务特性" tabindex="-1"><a class="header-anchor" href="#_1-事务特性" aria-hidden="true">#</a> 1. 事务特性</h4><p>事务的四大特性ACID</p><table><thead><tr><th>特性</th><th>描述</th></tr></thead><tbody><tr><td>原子性</td><td>事务是不可分割的最小操作单元,要么全部成功,要么全部失败</td></tr><tr><td>一致性</td><td>事务完成时,必须是所有的数据都保持一致状态</td></tr><tr><td>隔离性</td><td>数据库系统提供的隔离机制,保证事务不收外部并发影响操作</td></tr><tr><td>持久性</td><td>事务一旦提交或者回滚,它对数据库的数据改变是永久的</td></tr></tbody></table><h4 id="_2-事务操作" tabindex="-1"><a class="header-anchor" href="#_2-事务操作" aria-hidden="true">#</a> 2. 事务操作</h4><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code># 查看事务提交方式(1代表自动,0代表手动)
SELECT @@autocommit;
# 设置事务提交方式
SET @@autocommit = 0;
# 提交事务
...
# 回滚事务
ROLLBACK;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-并发事务问题" tabindex="-1"><a class="header-anchor" href="#_3-并发事务问题" aria-hidden="true">#</a> 3. 并发事务问题</h4><table><thead><tr><th>问题</th><th>描述</th></tr></thead><tbody><tr><td>脏读</td><td>一个事务读到另外一个事务还没有提交的数据</td></tr><tr><td>不可重复读</td><td>一个事务先后读取同一条数据,但两次读取的数据不同</td></tr><tr><td>幻读</td><td>一个事务查询数据时没有数据,但插入数据时,数据已经存在</td></tr></tbody></table><h4 id="_4-事务隔离级别" tabindex="-1"><a class="header-anchor" href="#_4-事务隔离级别" aria-hidden="true">#</a> 4. 事务隔离级别</h4><table><thead><tr><th>隔离级别</th><th>脏读</th><th>不可重复读</th><th>幻读</th></tr></thead><tbody><tr><td>Read uncommitted</td><td>√</td><td>√</td><td>√</td></tr><tr><td>Read committed</td><td>×</td><td>√</td><td>√</td></tr><tr><td>Repeatable Read(默认)</td><td>×</td><td>×</td><td>√</td></tr><tr><td>Serializable</td><td>×</td><td>×</td><td>×</td></tr></tbody></table><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code># 查看事务的隔离级别
SELECT @@TRANSACTION_ISOLATION;
# 设置事务的隔离级别
SET[SESSION|GLOBAL] TRANSACTION_ISOLATION LEVEL {隔离级别}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,129),l=[s];function r(v,m){return e(),t("div",null,l)}const b=d(a,[["render",r],["__file","MySQL-Basic.html.vue"]]);export{b as default};
